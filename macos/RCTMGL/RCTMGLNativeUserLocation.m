...
- (void)setMap:(RCTMGLMapView *)map
{
    if (map == nil && _map) {
        ...
        map.showsUserHeadingIndicator = self.macosShowsUserHeadingIndicator;
    }

    _map = map;
}

- (void)setIosShowsUserHeadingIndicator:(BOOL)macosShowsUserHeadingIndicator {
    _macosShowsUserHeadingIndicator = macosShowsUserHeadingIndicator;
    if (_map) {
        _map.showsUserHeadingIndicator = macosShowsUserHeadingIndicator;
    }
}
